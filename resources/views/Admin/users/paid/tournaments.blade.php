...
@section('title', 'Paid Users — Select Tournament')
...
<style>
    ...
    .ur-t-icon { width:46px;height:46px;border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.1rem;flex-shrink:0;background:#d1fae5;color:#059669; }
...
@section('content')
<div class="ur-header">
    <div><h2>Paid Users</h2><p>Select a tournament to view paid registrations.</p></div>
...
<div class="ur-tournament-list">
    @forelse($seasons as $season)
        <a href="{{ route('admin-users.paid.categories', $season->id) }}" class="ur-tournament-card">
