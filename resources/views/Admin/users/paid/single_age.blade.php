...
@section('title', 'Paid Singles — Select Age — ' . $season->name)
...
<div class="ur-header">
    <div>
        <h2>Paid Singles — Select Age Category</h2>
        <p>{{ $season->name }}</p>
    </div>
...
<div class="ur-age-intro">
    ...
    <p>Select an age group to view the paid singles registrations.</p>
</div>
...
<div class="ur-age-grid">
    ...
    <a href="{{ $cnt > 0 ? route('admin-users.paid.singles', [$season->id, urlencode($age)]) : '#' }}"
