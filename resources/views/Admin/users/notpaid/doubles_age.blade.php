...
@section('title', 'Pending Doubles — Select Age — ' . $season->name)
...
<div class="ur-header">
    <div>
        <h2>Pending Doubles — Select Age Category</h2>
        <p>{{ $season->name }}</p>
    </div>
...
<div class="ur-age-intro">
    ...
    <p>Select an age group to view pending doubles registrations.</p>
</div>
@php
...
<div class="ur-age-grid">
    ...
    <a href="{{ $cnt > 0 ? route('admin-users.notpaid.doubles', [$season->id, urlencode($age)]) : '#' }}"
