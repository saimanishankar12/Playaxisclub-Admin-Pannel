{{-- ============================================================
     FILE: resources/views/Admin/users/notpaid/categories.blade.php
     ============================================================ --}}
@extends('Admin.layouts.app')
@section('title', 'Not Paid — ' . $season->name)
...
<style>
    ...
    .ur-breadcrumb { display:flex;align-items:center;gap:6px;font-size:.78rem;color:#94a3b8;margin-bottom:24px;flex-wrap:wrap; }
...
@section('content')
<div class="ur-header">
    <div><h2>{{ $season->name }}</h2><p>Pending registrations — choose a category.</p></div>
...
<div class="ur-cat-grid">
    <a href="{{ route('admin-users.notpaid.singles.age', $season->id) }}" class="ur-cat-card ur-cat-card--singles">
        ...
        <div class="ur-cat-body">
            ...
            <div class="ur-cat-desc">Individual registrations awaiting payment.</div>
    ...
    <a href="{{ route('admin-users.notpaid.doubles.age', $season->id) }}" class="ur-cat-card ur-cat-card--doubles">
        <div class="ur-cat-band"></div>
        <div class="ur-cat-body">
            <div class="ur-cat-icon"><i class="fas fa-users"></i></div>
            <div class="ur-cat-title">Doubles</div>
            <div class="ur-cat-desc">Pair registrations awaiting payment.</div>
